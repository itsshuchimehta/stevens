...
myPath  = r"/Users/shuchimehta/Documents/CS600/ShuchiMehta_CS600_project/html"

#2. Acquiring list of web pages to crawl
links = [f for f in listdir(myPath) if isfile(join(myPath, f))]

#3. Mentioning the stopWords
...
def parseText(text: str):
    """Breaks long strings of text into a list of single individual words. Returns a list of the words"""
...
class Trie(object):
    ...
    def addWord(self, word: str, link: str, rank: int):
        ...
        if node.children:
            ...
            node.isPrefix = True
        """creation and updation of the rank and occurenceList for each node."""
        if node.rank:
            try:
...
if __name__ == "__main__":
    ...
    print("\n")
    print("Welcome to Shuchi's Search Engine!\n")
    x = True
    while x:
        ...
        if search == "q":
            ...
            if results:
                ...
                print("None\n") #Will print "None" if there are no results or if there's any error 
